...
import fr.ans.psc.amar.auth.ApiKeyAuth;
import fr.ans.psc.amar.auth.Authentication;
import fr.ans.psc.amar.auth.HttpBasicAuth;
import fr.ans.psc.amar.auth.OAuth;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2022-06-01T09:34:49.260Z[GMT]")@Component("fr.ans.psc.amar.ApiClient")
public class ApiClient {
    ...
    private String basePath = "http://localhost:8099";
